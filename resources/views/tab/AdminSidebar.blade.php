...
<div id="sidebar" class="sidebar">
    ...
    <ul class="menu">
        <li><a href="{{ route('admin.dashboard') }}">
            <img src="{{ asset('imgcons/dashboard.png') }}" class="icon" alt="">
            <span class="label">Dashboard</span>
        </a></li>

        <li><a href="{{ route('admin.ebook.list') }}">
            <img src="{{ asset('imgcons/Books.png') }}" class="icon" alt="">
            <span class="label">eBook Setup</span>
        </a></li>

        <li><a href="{{ route('admin.accounts') }}">
            <img src="{{ asset('imgcons/admin_setup.png') }}" class="icon" alt="">
            <span class="label">Admin Accounts</span>
        </a></li>

        <li><a href="{{ route('admin.useraccounts.index') }}">
            <img src="{{ asset('imgcons/user_setup.png') }}" class="icon" alt="">
            <span class="label">User Accounts</span>
        </a></li>

        <li><a href="{{ route('admin.research.index') }}">
            <img src="{{ asset('imgcons/research.png') }}" class="icon" alt="">
            <span class="label">Research</span>
        </a></li>

        <li><a href="{{ route('guest.logs') }}">
            <img src="{{ asset('imgcons/log.png') }}" class="icon" alt="">
        ...
        <li class="dropdown">
            <a href="javascript:void(0);" class="dropdown-toggle">
                <img src="{{ asset('imgcons/Setup.png') }}" class="icon" alt="">
