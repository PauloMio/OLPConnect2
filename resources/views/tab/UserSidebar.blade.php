    ...
    <ul class="menu">
        <li>
            <a href="{{ route('user.ebooks') }}">
                <img src="{{ asset('imgcons/Books.png') }}" class="icon" alt="eBooks">
                <span class="label">eBooks</span>
            </a>
        </li>
        <li>
            <a href="{{ route('user.favorites') }}">
                <img src="{{ asset('imgcons/favorite.png') }}" class="icon" alt="Favorites">
                <span class="label">Favorites</span>
            </a>
        </li>
        <li>
            <a href="{{ route('user.research') }}">
                <img src="{{ asset('imgcons/research.png') }}" class="icon" alt="Research">
